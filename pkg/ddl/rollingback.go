...
func rollingbackAddColumanrIndex(w *worker, jobCtx *jobContext, job *model.Job, columnarIndexType model.ColumnarIndexType) (ver int64, err error) {
...
func convertJob2RollbackJob(w *worker, jobCtx *jobContext, job *model.Job) (ver int64, err error) {
	...
	case model.ActionAddVectorIndex:
		ver, err = rollingbackAddColumanrIndex(w, jobCtx, job, model.ColumnarIndexTypeVector)
